...
<div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent">People have interacted with you on ${
    escapeHtml(name)
  }. Go check it out.</div>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:560px;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,'Liberation Mono',monospace">
  ...
  <tr><td bgcolor="#f1f5ee" style="padding:38px 32px;border:1px solid #d9dbd4;text-align:center">
    ...
    <p style="margin:0 auto 24px;max-width:430px;color:#3f443d;font-size:13px;line-height:1.7">Someone replied to one of your notes. Head back to ${
    escapeHtml(name)
  } to see what they said and continue the conversation.</p>
    <a href="${
    escapeHtml(activityUrl)
  }" style="display:inline-block;padding:11px 17px;color:#ffffff;background:#55734a;border:1px solid #49643f;text-decoration:none;font-size:13px;font-weight:700">Go check it out →</a>
  </td></tr>
  ...
  }" style="color:#55734a;text-decoration:underline">Unsubscribe from interaction emails</a>
  </td></tr>
