  ...
  return (
    <article className={`static-page about-page${embedded ? ' feed-about' : ''}`}>
      ...
      <p>
        ...
        and easy to follow. There are no likes, karma points, follower or following counts, or timestamps to bias what
        you read or influence what you choose to say. There are no engagement tricks or pressure to build an audience.
      </p>
      <p>
