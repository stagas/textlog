...
test('posting helpers are searchable details and show copyable highlighted results above actions', () => {
  ...
  expect(html).toContain('<dt>Polls</dt>')
  expect(html).toContain('Which one? <b>#poll</b><br/>First option<br/>Second option')
  expect(html).toContain('Second option</code><br/><small>Use 2–8 unique options.</small>')
  expect(html).toContain('<dt>Spoilers</dt>')
  expect(html).toContain('Visible text <b>#spoiler</b><br/>Hidden text')
  expect(html).toContain('<dt>Todos</dt>')
  ...
  expect(html).toContain('<dt>Pinned notes</dt>')
  ...
  expect(html).toContain('<dt>Locked conversations</dt>')
...
test('Profile edit offers a data download without rendering notes', () => {
  ...
  expect(html).toContain('160 chars / 5 lines max</span> · use #hashtags, @mentions and more</span>')
  expect(html).not.toContain('<h2>Find hashtags and people</h2>')
  expect(html).not.toContain('<h2>Formatting</h2>')
  expect(html).not.toContain('<h2>Emoji</h2>')
